...
CREATE FUNCTION http.get_test(jsonb, jsonb, jsonb) RETURNS table(environ jsonb, path jsonb, args jsonb) AS $$
       select $1, $2, $3;
$$ LANGUAGE SQL;

CREATE FUNCTION http.post_test(jsonb, jsonb, jsonb, bytea) RETURNS table(environ jsonb, path jsonb, args jsonb, request bytea) AS $$
       select $1, $2, $3, $4;
$$ LANGUAGE SQL;
